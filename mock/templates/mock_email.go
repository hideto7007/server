...
func (m *MockEmailTemplateService) DeleteSignInTemplate(UserName, DateTime string) (string, string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteSignInTemplate", UserName, DateTime)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(string)
	ret2, _ := ret[2].(error)
...
func (mr *MockEmailTemplateServiceMockRecorder) DeleteSignInTemplate(UserName, DateTime interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteSignInTemplate", reflect.TypeOf((*MockEmailTemplateService)(nil).DeleteSignInTemplate), UserName, DateTime)
}
